...
export default function TradeTheme() {
    ...
    useEffect(() => {
        const button = document.querySelector('#toggle') as HTMLInputElement
    ...
    return (
        <>
            <label id="theme-toggle-button" className='top-2 left-2 shadow-sm shadow-blue-300 rounded-full' onClick={() => {
                const button = document.querySelector('#toggle') as HTMLInputElement
                if (button?.checked) {
